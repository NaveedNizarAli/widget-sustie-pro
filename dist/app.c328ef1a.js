  ...
  _createClass(Widget, [{
    ...
    value: function initialise() {
      ...
      setTimeout(function () {
        ...
        _this.messageContainer.classList.add('hidden1', 'message-container');
